...
loadConstraints -path "$::DIR_PATH/xdc/MigCore_board.xdc"
set_property USED_IN {synthesis implementation board} [get_files {MigCore_board.xdc}]
set_property PROCESSING_ORDER {EARLY}     [get_files {MigCore_board.xdc}]
set_property SCOPED_TO_REF    {MigCore}   [get_files {MigCore_board.xdc}]
set_property SCOPED_TO_CELLS  {inst}      [get_files {MigCore_board.xdc}]
