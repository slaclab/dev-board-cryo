...
set_property PACKAGE_PIN G12  [get_ports { sfpTxDisable[0] }]
set_property IOSTANDARD  LVCMOS12 [get_ports { sfpTxDisable[0] }]
...
set_property PACKAGE_PIN G10 [get_ports { sfpTxDisable[1] }]
set_property IOSTANDARD  LVCMOS12 [get_ports { sfpTxDisable[1] }]
...
set_property PACKAGE_PIN K12 [get_ports { sfpTxDisable[2] }]
set_property IOSTANDARD  LVCMOS12 [get_ports { sfpTxDisable[2] }]
...
set_property PACKAGE_PIN J7  [get_ports { sfpTxDisable[3] }]
set_property IOSTANDARD  LVCMOS12 [get_ports { sfpTxDisable[3] }]
