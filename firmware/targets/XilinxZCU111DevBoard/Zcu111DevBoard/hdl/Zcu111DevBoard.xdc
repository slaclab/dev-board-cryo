...
set_property PACKAGE_PIN G12  [get_ports { sfpTxDisableN[0] }]
set_property IOSTANDARD  LVCMOS12 [get_ports { sfpTxDisableN[0] }]
...
set_property PACKAGE_PIN G10 [get_ports { sfpTxDisableN[1] }]
set_property IOSTANDARD  LVCMOS12 [get_ports { sfpTxDisableN[1] }]
...
set_property PACKAGE_PIN K12 [get_ports { sfpTxDisableN[2] }]
set_property IOSTANDARD  LVCMOS12 [get_ports { sfpTxDisableN[2] }]
...
set_property PACKAGE_PIN J7  [get_ports { sfpTxDisableN[3] }]
set_property IOSTANDARD  LVCMOS12 [get_ports { sfpTxDisableN[3] }]
